...
const HomeBottomText = () => {
  return (
    <div className='font-[font2] flex items-center justify-center gap-4  '>
      <div className='text-[6.5vw] uppercase border-5 border-black hover:border-green-500 rounded-full px-10 pb-3 pt-1 hover:text-amber-200 duration-200 leading-[5.5vw] italic  text-white'  >
